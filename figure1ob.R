...
ggplot(data = figure1) + geom_line(aes(x = date, y = values, color = color)) + 
  theme_minimal() + xlab("") + ylab("Prix des véhicules automobiles occasion - CP07112\nIndice Janv. 2019 = 100") +
...
ggsave("figure1ob.png", width = 1.25*6, height = 1.25*3.375, bg = "white", dpi = 150)
ggsave("figure1ob.pdf", width = 1.25*6, height = 1.25*3.375, dpi = 150)
